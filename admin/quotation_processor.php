...
if(isset($_POST['submit_order'])){
  ...
  $sql = "INSERT INTO `tbl_sales_orders`(order_number, item, customer_name, total_amount, delivery_deadline) VALUES(:order_number, :item_id, :customer_name, :total_price, :end_date)";
