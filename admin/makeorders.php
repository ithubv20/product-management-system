...
if (empty($_SESSION['user_id'])){
  ...
  <div class="card shadow mb-4">
    ...
    <div class="table-responsive">
      <?php
      $sql = "SELECT tbl_sales_orders.*, tbl_items.item_name, tbl_items.item_materials, tbl_items.item_operations, tbl_stock.in_stock, tbl_stock.expected_date FROM tbl_sales_orders INNER JOIN tbl_stock ON tbl_sales_orders.item = tbl_stock.item_name INNER JOIN tbl_items ON tbl_sales_orders.item = tbl_items.id WHERE tbl_sales_orders.order_status = 1 AND tbl_sales_orders.make_status = 1";
