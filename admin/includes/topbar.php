...
<div id="content-wrapper" class="d-flex flex-column">
  ...
  <a class="dropdown-item d-flex align-items-center" href="#">
    ...
    <div>
      ...
      MWK29000.00 has been deposited into your account!
    </div>
  </a>
  <a class="dropdown-item d-flex align-items-center" href="#">
    <div class="mr-3">
...
<li class="nav-item dropdown no-arrow">
  ...
  {
    foreach($rows as $row) {?>
      <span class="mr-2 d-none d-lg-inline text-gray-600 small"><?php echo htmlentities('Welcome'."  ".$row['user_name'].'!') ?></span>
    <?php }
  }?>
  <img class="img-profile rounded-circle"
  src="../assets/img/logo/rubi_icon.png">
</a>
